...
[assembly: AssemblyInformationalVersion(RevisionClass.FullVersion + "-9fc10009")]
...
internal static class RevisionClass
{
	...
	public const string Revision = "1741";
	public const string VersionName = null;
	
	public const string FullVersion = Major + "." + Minor + "." + Build + ".1741";
}
